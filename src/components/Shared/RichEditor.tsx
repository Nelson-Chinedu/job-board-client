import React, { MouseEvent, useRef, FunctionComponent, Dispatch, SetStateAction } from 'react';
...
export const RichEditor: FunctionComponent<Props> = (props) => {
  ...
  return (
    <>
      <p className="mb-0 text-base font-semibold">{props.editorLabel}</p>
      <div className={`RichEditor-root ${props.containerClassName} mt-2`}>
        <BlockStyleControls
          editorState={editorState}
