...
import { positionType, roleType } from "../Constant";
...
const validationSchema = Yup.object().shape({
  ...
  roleType: Yup.string().required("Please select a focus area."),
  positionType: Yup.string().required("Please select a position area."),
  applicationMode: Yup.string().required(
  ...
  companyHeadquarter: Yup.string().required(
    ...
    <>
      ...
      <div className="c-form-step w-1/2 mx-auto">
        <form onSubmit={handleSubmit}>
          ...
          >
            {current === 0 && <AboutRole />}
            {current === 1 && <AboutCompany />}
            {current === 2 && <PreviewForm />}
          </FormContext.Provider>
